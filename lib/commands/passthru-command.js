...
function reconstructArgsString( argv ) {
	"use strict";
	var x,
		argsArray = [],
		argString = '',
	...
	return argsArray.concat( argv._.slice( 1 ) );
}
...
PassthruCommand.prototype.cliCommand = function () {
	"use strict";
	var args = reconstructArgsString( app.argv );
 ...
 * @returns {NPromise}
 */
PassthruCommand.prototype.command = function ( url, extraArgs, rawArgs ) {
	"use strict";
	var SELF = this;
