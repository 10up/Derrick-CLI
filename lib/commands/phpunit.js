...
/**
 * Make sure we send the correct configuration flag.
 *
 ...
 */
var phpunit = new PassthruCommand( 'phpunit' );

/**
 * Adjust any arguments we need.
 *
 * @param {Array} args
 *
 * @returns {Array}
...
phpunit.adjustArgs = function( args ) {
	return tweakConfiguration( args );
};

/**
 * Export the passthru command.
 *
 * @type {Object}
 */
